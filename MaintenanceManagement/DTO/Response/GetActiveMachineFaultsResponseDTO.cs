...
{
    public record GetActiveMachineFaultsResponseDTO
    {

        public GetActiveMachineFaultsResponseDTO(int id, string machineName, int machineId, int faultTypeValue, int faultPriorityValue,
